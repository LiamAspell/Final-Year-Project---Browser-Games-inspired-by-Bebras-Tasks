"""
Names specific to command-line version of game Glasses.

Uses the CTGames framework. Run from directory `CTGames/bin` in a Linux
terminal using:

    python cli.py glasses
"""

# CTGames framework
from ctgames.ctgamestypes import GameState
from ctgames.glasses import SublevelBehaviour
...
DEFAULT_ROUND_BEHAVIOUR: SublevelBehaviour = SublevelBehaviour(rules_amount=3)
...
def construct_cl_formatted_strings(game_state: GameState) -> dict:
    ...
    (question_sequence) = game_state.custom
